...
class Train(object):
    ...
    def get_images(self):
        ...
        objects """
        images = []
        for image_dir in self.args.inputs:
        ...
        for i,input in enumerate(self.args.inputs):
            print('Model {} Directory: {}'.format(i,input))
        return images
    ...
    def load_model(self):
        ...
        model = PluginLoader.get_model(self.trainer_name)(len(self.args.inputs), model_dir, self.args.gpus)
        model.load()
